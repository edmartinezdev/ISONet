...
class FeedCommentModel{
  ...
  int? filterRecord;
  int? commentCount;
  List<CommentListData>? commentListData;

  FeedCommentModel({this.totalRecord, this.filterRecord, this.commentListData});
  ...
  FeedCommentModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['feed_comments'] != null) {
      ...
      json['feed_comments'].forEach((v) {
        commentListData!.add(CommentListData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (commentListData != null) {
      data['feed_comments'] =
          commentListData!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class ForumCommentModel {
  ...
  int? filterRecord;
  int? commentCount;
  List<CommentListData>? forumCommentListData;
  ...
  ForumCommentModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['forum_comments'] != null) {
      forumCommentListData = <CommentListData>[];
      json['forum_comments'].forEach((v) {
        forumCommentListData!.add(CommentListData.fromJson(v));
      });
    }
  }
...
class ArticleCommentModel {
  ...
  int? filterRecord;
  int? commentCount;
  List<CommentListData>? articleCommentListData;
  ...
  ArticleCommentModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['article_comments'] != null) {
      articleCommentListData = <CommentListData>[];
      json['article_comments'].forEach((v) {
        articleCommentListData!.add(CommentListData.fromJson(v));
      });
    }
  }
...
///******Common Comment model For Article , Feed & Forum *************///
class CommentListData {
  ...
  RxList<CommentReplies> commentReplies = <CommentReplies>[].obs;
  ...
  CommentListData({this.user, this.mainCommentId, this.comment, this.likes, this.createdAt, this.updatedAt, this.likedByUser});
...
class User {
  ...
  User({this.userId, this.firstName, this.lastName, this.profileImg, this.companyId,this.isVerified});
