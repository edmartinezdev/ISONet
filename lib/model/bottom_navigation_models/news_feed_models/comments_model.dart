...
class FeedCommentsModel {
  int? totalRecord;
  int? filterRecord;
  List<CommentListData>? commentListData;

  FeedCommentsModel({this.totalRecord, this.filterRecord, this.commentListData});

  FeedCommentsModel.fromJson(Map<String, dynamic> json) {
...
class CommentListData {
  ...
  var isLikeReplyFeed = <bool>[].obs;
  var likesReplyCounters = <int>[].obs;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (commentReplies != null) {
      data['comment_replies'] =
          commentReplies!.map((v) => v.toJson()).toList();
    }
